...
import objectSpaceRaymarchDepthFrag from '@/PaleGL/shaders/gbuffer-object-space-raymarch-depth-fragment.glsl';
...
// TODO: 実質的にLitのMaterialなので、ObjectSpaceRaymarchから命名剝がしたい
export class ObjectSpaceRaymarchMaterial extends Material {
    ...
    start({ gpu, attributeDescriptors = [] }: { gpu: GPU; attributeDescriptors: AttributeDescriptor[] }) {
        ...
        this.depthFragmentShader = objectSpaceRaymarchDepthFrag;
