...
class Mesh extends Actor {
    ...
    start(options) {
        ...
        // console.log("hogehoge", this.mainMaterial.name, !!this.mainMaterial.vertexShader, !!this.depthMaterial, !!this.autoGenerateDepthMaterial, this.mainMaterial.vertexShader)
        // if(
        //     !this.depthMaterial &&
