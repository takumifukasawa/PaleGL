...
export class ArrowGeometry extends Geometry {
    constructor({ gpu }) {
        const boxPosition_0 = [-0.05, 0.05, 2];
        const boxPosition_1 = [-0.05, -0.05, 2];
        const boxPosition_2 = [0.05, 0.05, 2];
        const boxPosition_3 = [0.05, -0.05, 2];
        const boxPosition_4 = [0.25, 0.25, 0];
        const boxPosition_5 = [0.25, -0.25, 0];
        const boxPosition_6 = [-0.25, 0.25, 0];
        const boxPosition_7 = [-0.25, -0.25, 0];
