...
import { ACTOR_TYPE_MESH, MeshType, MESH_TYPE_DEFAULT } from '@/PaleGL/constants.ts';
...
export function createMesh({
    ...
    // const actor = createActor({ name, type: type !== undefined ? type : ACTOR_TYPE_MESH });
    const actor = createActor({ name, type: type !== undefined ? type : ACTOR_TYPE_MESH });
    ...
    return {
        ...actor,
        meshType: meshType ?? MESH_TYPE_DEFAULT,
        // meshType,
        geometry,
        materials,
        depthMaterials,
