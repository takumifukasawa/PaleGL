...
// };
// 
// export function createGPU(_gl: WebGL2RenderingContext) {
//     const gl: WebGL2RenderingContext = _gl;
//     const _shader: Shader | null = null;
//     const _vao: VertexArrayObject | null = null;
//     const _uniforms: Uniforms | null = null;
//     const _dummyTexture: Texture;
//     const _dummyTextureBlack: Texture;
//     const _dummyCubeTexture: CubeMap;
//     const _validExtensions: string[] = [];
//     const _invalidExtensions: string[] = [];
//     const _uboBindingPoint: number = 0;
// 
//         _dummyTexture = new Texture({
//             gpu: this,
//             img: create1x1('white'),
//             wrapS: TextureWrapTypes.Repeat,
//             wrapT: TextureWrapTypes.Repeat,
