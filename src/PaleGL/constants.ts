...
export const SHADER_DEFINE_RECEIVE_SHADOW = "USE_RECEIVE_SHADOW";
export const SHADER_DEFINE_SKINNING_GPU = "USE_SKINNING_GPU";
export const SHADER_DEFINE_SKINNING_CPU = "USE_SKINNING_CPU";
export const SHADER_DEFINE_NORMAL_MAP = "USE_NORMAL_MAP";
export const SHADER_DEFINE_ENV_MAP = "USE_ENV_MAP";
export const SHADER_DEFINE_VERTEX_COLOR = "USE_VERTEX_COLOR";
export const SHADER_DEFINE_ALPHA_TEST = "USE_ALPHA_TEST";
export const SHADER_DEFINE_INSTANCING = "USE_INSTANCING";
export const SHADER_DEFINE_INSTANCE_LOOK_DIRECTION = "USE_INSTANCE_LOOK_DIRECTION";
export const SHADER_DEFINE_VAT = "USE_VAT";
export const SHADER_DEFINE_VAT_LOOK_FORWARD = "USE_VAT_LOOK_FORWARD";
export const SHADER_DEFINE_TRAIL = "USE_TRAIL";
export const SHADER_DEFINE_HEIGHT_MAP = "USE_HEIGHT_MAP";
