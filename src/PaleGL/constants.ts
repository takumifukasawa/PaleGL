...
export const UNIFORM_NAME_MAP_TILING = 'uMapTiling';
...
export const UNIFORM_NAME_EFFECT_TEXTURE_COMPOSITE_TILING_ENABLED = 'uTilingEnabled';
export const UNIFORM_NAME_EFFECT_TEXTURE_COMPOSITE_EDGE_MASK_MIX = 'uEdgeMaskMix';
export const UNIFORM_NAME_EFFECT_TEXTURE_COMPOSITE_REMAP_MIN = 'uRemapMin';
export const UNIFORM_NAME_EFFECT_TEXTURE_COMPOSITE_REMAP_MAX = 'uRemapMax';
export const UNIFORM_NAME_EFFECT_TEXTURE_COMPOSITE_ONE_MINUS = 'uOneMinus';
export const UNIFORM_NAME_TEXTURE_CELL_SIZE = 'uCellSize';
...
export const SHADER_DEFINE_RECEIVE_SHADOW = "D_RECEIVE_SHADOW";
export const SHADER_DEFINE_SKINNING_GPU = "D_SKINNING_GPU";
export const SHADER_DEFINE_SKINNING_CPU = "D_SKINNING_CPU";
export const SHADER_DEFINE_NORMAL_MAP = "D_NORMAL_MAP";
export const SHADER_DEFINE_ENV_MAP = "D_ENV_MAP";
export const SHADER_DEFINE_VERTEX_COLOR = "D_VERTEX_COLOR";
export const SHADER_DEFINE_ALPHA_TEST = "D_ALPHA_TEST";
export const SHADER_DEFINE_INSTANCING = "D_INSTANCING";
export const SHADER_DEFINE_INSTANCE_LOOK_DIRECTION = "D_INSTANCE_LOOK_DIRECTION";
export const SHADER_DEFINE_VAT = "D_VAT";
export const SHADER_DEFINE_VAT_LOOK_FORWARD = "D_VAT_LOOK_FORWARD";
export const SHADER_DEFINE_TRAIL = "D_TRAIL";
export const SHADER_DEFINE_HEIGHT_MAP = "D_HEIGHT_MAP";
...
export const FRAGMENT_SHADER_MODIFIER_PRAGMA_GBUFFER_BUILDER_DEFAULT = 'GBUFFER_BUILDER_DEFAULT';
export const FRAGMENT_SHADER_MODIFIER_PRAGMA_GBUFFER_BUILDER_RAYMARCH = 'GBUFFER_BUILDER_RAYMARCH';
...
export type FragmentShaderModifierPragmas =
    ...
    | typeof FRAGMENT_SHADER_MODIFIER_PRAGMA_GBUFFER_BUILDER_DEFAULT
    | typeof FRAGMENT_SHADER_MODIFIER_PRAGMA_GBUFFER_BUILDER_RAYMARCH;
...
export const SHADER_PRAGMA_BASE_ATTRIBUTES = 'BASE_ATTRIBUTES';
