...
export const createDeferredShadingPass = (args: DeferredShadingPassArgs): DeferredShadingPass => {
    ...
    const uniforms: UniformsData = [
        ...
        [UNIFORM_NAME_GBUFFER_D_TEXTURE, UNIFORM_TYPE_TEXTURE],
        [UNIFORM_NAME_DEPTH_TEXTURE, UNIFORM_TYPE_TEXTURE],
        [UNIFORM_NAME_SCREEN_SPACE_SHADOW_TEXTURE, UNIFORM_TYPE_TEXTURE],
        [UNIFORM_NAME_AMBIENT_OCCLUSION_TEXTURE, UNIFORM_TYPE_TEXTURE],

        [UNIFORM_NAME_DIRECTIONAL_LIGHT_SHADOW_MAP, UNIFORM_TYPE_TEXTURE],

        [
            UNIFORM_NAME_SPOT_LIGHT_SHADOW_MAP,
            UNIFORM_TYPE_TEXTURE_ARRAY,
            Array(MAX_SPOT_LIGHT_COUNT),
        ],
...
export const createSkyboxUniforms = (): UniformsData => {
    return [
        [
            ...
            UNIFORM_TYPE_STRUCT,
            [
                [UNIFORM_NAME_STRUCT_MEMBER_CUBE_MAP, UNIFORM_TYPE_CUBE_MAP],
