...
export const createBloomPass = (args: BloomPassArgs): BloomPass => {
    ...
    const compositePass = createFragmentPass({
        ...
        uniforms: [
            [UNIFORM_NAME_SRC_TEXTURE, UNIFORM_TYPE_TEXTURE],
            [UNIFORM_NAME_BLUR_4_TEXTURE, UNIFORM_TYPE_TEXTURE],
            [UNIFORM_NAME_BLUR_8_TEXTURE, UNIFORM_TYPE_TEXTURE],
            [UNIFORM_NAME_BLUR_16_TEXTURE, UNIFORM_TYPE_TEXTURE],
            [UNIFORM_NAME_BLUR_32_TEXTURE, UNIFORM_TYPE_TEXTURE],
            [UNIFORM_NAME_BLUR_64_TEXTURE, UNIFORM_TYPE_TEXTURE],
            [UNIFORM_NAME_TONE, UNIFORM_TYPE_FLOAT, tone],
            [UNIFORM_NAME_BLOOM_AMOUNT, UNIFORM_TYPE_FLOAT, bloomAmount],
            [UNIFORM_NAME_EXTRACT_TEXTURE, UNIFORM_TYPE_TEXTURE],
            ...getPostProcessCommonUniforms(),
        ],
        renderTargetType: RENDER_TARGET_TYPE_R11F_G11F_B10F,
    });
...
export function setBloomPassSize(postProcessPass: PostProcessPass, width: number, height: number) {
