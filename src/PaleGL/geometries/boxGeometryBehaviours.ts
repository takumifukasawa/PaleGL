...
export const getBoxGeometryRandomLocalPositionOnEdge = (geometry:BoxGeometry, rand1: number, rand2: number): Vector3 => {
...
export const getBoxGeometryRandomLocalPositionOnSurface = (geometry: BoxGeometry, index: number, rand2: number, rand3: number): Vector3 => {
