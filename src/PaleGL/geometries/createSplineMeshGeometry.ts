...
export const updateSplineMeshGeometry = (geometry: Geometry, splineMeshData: SplineMeshData) => {
    const { controlPoints, crossSection, segmentSamples, caps, modifiers } = splineMeshData;
